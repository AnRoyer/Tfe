...
Macro SolveAndStepForward
  ...
  If( proc == MPI_Rank && ProcOwnsDomain(i_f) )
    ...
    If( NbrRegions[Sigma~{i_f}~{1}] )
      GenerateRHSGroup[SurPc~{i_f}~{1}, Region[{Sigma~{i_f}~{1},
            TrPmlSigma~{i_f}~{1}, BndSigma~{i_f}~{1},
            TrBndPmlSigma~{i_f}~{1}}]];
...
Macro SolveAndStepBackward
  ...
  If( proc == MPI_Rank && ProcOwnsDomain(i_b) )
    ...
    If( NbrRegions[Sigma~{i_b}~{0}] )
      GenerateRHSGroup[SurPc~{i_b}~{0}, Region[{Sigma~{i_b}~{0},
            TrPmlSigma~{i_b}~{0}, BndSigma~{i_b}~{0},
            TrBndPmlSigma~{i_b}~{0}}]];
...
Macro InitSweep
  ...
  If( proc == MPI_Rank && ProcOwnsDomain(i) )
    If (PRECONDITIONER == 2)
      ...
      For j In{0:1}
        If( NbrRegions[Sigma~{i}~{j}] )
          GenerateRHSGroup[SurPc~{i}~{j}, Region[{Sigma~{i}~{j},
                TrPmlSigma~{i}~{j}}]];
